...
"""
500 room graph
edges are directions N, S, E, W
Need to traverse through the graph visiting every room in order in < 2000 moves.

Steps:
Visit room
find all possible exits 
move a direction and repeat
Need to keep track of visited rooms/paths
need set direction back tracking in the path
DFT best soltion? 
"""
