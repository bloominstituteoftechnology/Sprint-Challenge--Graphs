...
def explore(player, world, traversalPath,visited):
    trackBackPaths = Stack()
    while len(visited) < len(roomGraph):
        thisRoom = player.currentRoom
        visited.add(thisRoom.id)
        # print(f"visited rooms: {visited}")
        
        #check for exits in this room
        roomExits = thisRoom.getExits()
        #initialize empty list for room numbers that exits go to
        roomNumbers = []
        for direction in roomExits:
            #associate room numbers with exits
            roomNumbers.append(thisRoom.getRoomInDirection(direction))
        #initialize empty list for unexplored directions connected to exits
        ...
        # print(f"unexploredDirections from room: {unexploredDirections}")
        
        
        #The movement stuff
        if len(unexploredDirections) > 0:
                #pick a direction to move randomly based upon unexplored
            ...
            # add trackBackDir to this pathBack
                
            pathBack.append(trackBackDir)
            player.travel(moveDir, False)
            traversalPath.append(moveDir)
            # print(f"traversalPath from inside move loop: {traversalPath}")
        if len(unexploredDirections) == 0:
            if trackBackPaths.size()>0:
                # print(f"going back. Size of path stack= {trackBackPaths.size()}")
                ...
                while len(pathBack) >0:
                    ...
                    # print(f"traversalPath from inside backtrack loop: {traversalPath}")
            else:
                # print(f"this is returning from the else: {traversalPath}")
                return traversalPath
    # print(f"this is the traversalPath I am returning: {traversalPath}")
    return traversalPath
...
def mainLoop(attempts, world):
    ...
    for a in range(attempts):
        ...
        trackBackPaths = Stack()
        traversalPath = []
        explore(player,world,traversalPath,visited)
        print(f"rooms visited: {len(visited)}")
        if len(traversalPath) < len(bestPath):
            bestPath = traversalPath
        # print(f"traversalPath from mainLoop: {traversalPath}")
        # print(f"length: {len(traversalPath)}")
        # print(f"bestPath from mainLoop: {bestPath}")
        print(f"length: {len(bestPath)}")
...
# print(f"global traversalPath: {traversalPath}")
...
['s', 'w', 'e', 'n', 'n', 's', 'w', 'w', 's', 'w', 's', 's', 'n', 'n', 'e', 'n', 'e', 'n', 'w', 'w', 's', 'n', 'w', 's', 's', 's', 'w', 'w', 'w', 's', 'w', 'n', 's', 'e', 'n', 'e', 'e', 'n', 'w', 'w', 'w', 'e', 'e', 'e', 's', 'e', 's', 'w', 'w', 'e', 's', 'w', 'e', 'n', 'e', 's', 's', 's', 's', 's', 's', 's', 's', 'w', 'e', 'n', 'e', 'e', 's', 's', 's', 'w', 'e', 'n', 'e', 'w', 'n', 'n', 'w', 's', 'n', 'w', 'n', 'n', 'n', 'w', 's', 's', 's', 'n', 'n', 'w', 's', 'w', 'e', 's', 'w', 'e', 'n', 'n', 'e', 'n', 'e', 'n', 'n', 'w', 's', 'w', 's', 'w', 's', 'n', 'e', 'n', 'w', 'w', 's', 'w', 'w', 'e', 'e', 's', 'w', 's', 's', 'w', 'e', 's', 's', 'n', 'w', 'w', 'e', 'e', 'n', 'n', 'w', 'e', 'n', 'w', 'w', 'w', 'e', 'e', 'e', 'e', 's', 's', 's', 'e', 'w', 's', 'e', 'w', 'n', 'n', 'n', 'n', 'n', 'n', 'w', 'e', 'e', 'e