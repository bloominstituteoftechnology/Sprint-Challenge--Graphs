...
def dft_recursive(self, starting_room, path=None, graph=None):
        """
        ...
        def dft_r(starting_room, path=path, graph=graph, coming_from_direction=None):
        ...
        return dft_r(self, starting_room)
...
traversalPath = []
graph = {}
traversalPath = dft_recursive(player.currentRoom, traversalPath, graph)
