...
# for room in range(len(roomGraph)):
#     rooms.add_vertex(room)
#     for exit in roomGraph[room][1]:
#         exitRoom = roomGraph[room][1][exit]
#         rooms.add_vertex(exitRoom)
#         print(room, exitRoom)
#         rooms.add_edge(room, exitRoom)
#         rooms.add_edge(exitRoom, room)
#         print(rooms.vertices)

traversalPath = [] 
"""
This is what we are going to create to pass the test.
And our guy has to walk it.
We want the len(traversalPath) to be as small as possible.
    traversalPath = ['n','e',...]
"""
"""
We want to keep track of rooms we have visited
"""
visited = set()
"""
