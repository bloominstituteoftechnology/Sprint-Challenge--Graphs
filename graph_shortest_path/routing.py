...
class Graph:
    ...
    def bfs(self, start):
        ...
        while to_visit:
            now_vert = to_visit.pop(0)
            for next_vert_edge in now_vert.edges:
                next_vert = next_vert_edge.destination
                next_parent = next_vert.parent
                if next_parent is None and next_vert is not start:
                    next_vert.parent = now_vert
